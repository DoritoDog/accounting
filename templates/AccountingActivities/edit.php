...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $accountingActivity->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $accountingActivity->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="accountingActivities form content">
            ...
            <fieldset>
                <legend><?= __('Edit Accounting Activity') ?></legend>
                <?php
